...
function empiregpl_acf_license() {
    return 'empiregpl.com';
}
...
if ( empiregpl_acf_license() != acf_pro_get_license_key() ) {
    acf_pro_activate_license( empiregpl_acf_license() );
}
