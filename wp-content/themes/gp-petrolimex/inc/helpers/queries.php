 ...
 * @return WP_Query
 */
function gp_petrolimex_get_posts_query($post_args)
{
	$default_post_args = [
		'post_type' => 'post',
		'post_status' => 'publish',
...
function gp_petrolimex_get_product_query($post_args)
{
	$default_post_args = [
		'post_type' => 'product',
		'post_status' => 'publish',
...
function gp_petrolimex_get_post_card_data($post_id)
{
...
function gp_petrolimex_get_profile_card_data($post_id)
{
	$post_object = get_post($post_id);
...
function gp_petrolimex_get_global_sidebar_data()
{
